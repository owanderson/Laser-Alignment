...
/*
 *
 * Say that GPIO13 moves a mirror in the x-direction (left-right)
 * and that GPIO06 moves a mirror in the y-direction (up-down).
 *
*/
...
void MainWindow::rasterPress()
{
    for (int n = 0; n < 5; n++)
    {
        ...
        std::system("./MoveRight 06");
        statusBar() -> showMessage("Moving GPIO06 Right");
